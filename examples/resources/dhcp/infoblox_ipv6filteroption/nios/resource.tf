...
resource "infoblox_ipv6filteroption" "dhcp_ipv6filteroption_with_basic_fields" {
  nios = {
...
resource "infoblox_ipv6filteroption" "dhcp_ipv6filteroption_with_additional_fields" {
  nios = {
