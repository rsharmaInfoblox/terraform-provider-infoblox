...
var (
	_ resource.Resource                   = &Ipv6filteroptionResource{}
	_ resource.ResourceWithValidateConfig = &Ipv6filteroptionResource{}
	_ resource.ResourceWithConfigure      = &Ipv6filteroptionResource{}
	_ resource.ResourceWithImportState    = &Ipv6filteroptionResource{}
	_ resource.ResourceWithIdentity       = &Ipv6filteroptionResource{}
)
...
type Ipv6filteroptionResource struct {
	...
	service coresvc.Ipv6filteroptionService
}
...
func (r *Ipv6filteroptionResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *Ipv6filteroptionResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox Ipv6filteroption in both NIOS and UDDI backends.",
		Attributes:          Ipv6filteroptionResourceSchemaAttributes,
	}
}

func (r *Ipv6filteroptionResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewIpv6filteroptionService(r.backend, client.NIOS, client.UDDI)
}

func (r *Ipv6filteroptionResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.Ipv6filteroption](r.backend, op)
}

func (r *Ipv6filteroptionResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateIpv6filteroption(ctx, data, resp)
}
...
func (r *Ipv6filteroptionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if r.backend == core.BackendNIOS {
		nios := flex.ExpandNestedObject[NIOSIpv6filteroptionModel](ctx, data.NIOS, &resp.Diagnostics)
		if nios == nil {
			nios = &NIOSIpv6filteroptionModel{}
		}
		nios.ExtAttrs = flex.SetInternalID(ctx, nios.ExtAttrs, &resp.Diagnostics)
		if resp.Diagnostics.HasError() {
			return
		}
		data.NIOS = flex.FlattenNestedObject(ctx, nios, NIOSIpv6filteroptionAttrTypes, &resp.Diagnostics)
	}
	...
	var (
		apiResp  *coremodel.Ipv6filteroption
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create Ipv6filteroption: %s", err))
		return
	}
...
func (r *Ipv6filteroptionResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read Ipv6filteroption: %s", err))
		return
	}
	...
	if r.backend == core.BackendNIOS && associateInternalId == nil && apiResp.NIOS != nil {
		...
		stateNIOS := flex.ExpandNestedObject[NIOSIpv6filteroptionModel](ctx, data.NIOS, &resp.Diagnostics)
		if stateNIOS == nil || stateNIOS.ExtAttrsAll.IsNull() || stateNIOS.ExtAttrsAll.IsUnknown() {
			resp.Diagnostics.AddError(
				"Missing Internal ID",
				"Unable to read Ipv6filteroption because the internal ID (from ext_attrs_all) is missing or invalid.",
			)
			return
		}
...
func (r *Ipv6filteroptionResource) ReadByExtAttrs(ctx context.Context, data *Ipv6filteroptionModel, resp *resource.ReadResponse) bool {
	...
	var (
		records  []*coremodel.Ipv6filteroption
		httpResp *http.Response
	)
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to search Ipv6filteroption by extattrs: %s", err))
		return true
	}
...
func (r *Ipv6filteroptionResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if r.backend == core.BackendNIOS {
		...
		planNIOS := flex.ExpandNestedObject[NIOSIpv6filteroptionModel](ctx, data.NIOS, &resp.Diagnostics)
		stateNIOS := flex.ExpandNestedObject[NIOSIpv6filteroptionModel](ctx, stateNIOSObj, &resp.Diagnostics)
		if planNIOS == nil {
			planNIOS = &NIOSIpv6filteroptionModel{}
		}
		...
		data.NIOS = flex.FlattenNestedObject(ctx, planNIOS, NIOSIpv6filteroptionAttrTypes, &resp.Diagnostics)
	}
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update Ipv6filteroption: %s", err))
		return
	}

	// Restore the plan ext_attrs (without inherited EAs) so Flatten preserves the user's input
	if r.backend == core.BackendNIOS {
		niosObj := flex.ExpandNestedObject[NIOSIpv6filteroptionModel](ctx, data.NIOS, &resp.Diagnostics)
		if niosObj != nil {
			niosObj.ExtAttrs = planExtAttrs
			data.NIOS = flex.FlattenNestedObject(ctx, niosObj, NIOSIpv6filteroptionAttrTypes, &resp.Diagnostics)
			if resp.Diagnostics.HasError() {
				return
			}
		}
...
func (r *Ipv6filteroptionResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete Ipv6filteroption: %s", err))
	}
}
