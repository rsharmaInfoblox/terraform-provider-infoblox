...
// Ipv6filteroptionOptionListModel is the Terraform model for Ipv6filteroptionOptionList
...
// Ipv6filteroptionOptionListAttrTypes contains the attribute types for Ipv6filteroptionOptionListModel
...
// Ipv6filteroptionOptionListResourceSchemaAttributes contains the schema attributes for Ipv6filteroptionOptionListModel
...
// ExpandIpv6filteroptionOptionList converts a Terraform Object to SDK type
func ExpandIpv6filteroptionOptionList(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdhcp.Ipv6filteroptionOptionList {
...
func (m *Ipv6filteroptionOptionListModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdhcp.Ipv6filteroptionOptionList {
	if m == nil {
		return nil
	}
...
// FlattenIpv6filteroptionOptionList converts an SDK type to Terraform Object
func FlattenIpv6filteroptionOptionList(ctx context.Context, from *niosdhcp.Ipv6filteroptionOptionList, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *Ipv6filteroptionOptionListModel) Flatten(ctx context.Context, from *niosdhcp.Ipv6filteroptionOptionList, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
