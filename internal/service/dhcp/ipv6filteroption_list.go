...
var (
	_ list.ListResource                   = &Ipv6filteroptionList{}
	_ list.ListResourceWithConfigure      = &Ipv6filteroptionList{}
	_ list.ListResourceWithValidateConfig = &Ipv6filteroptionList{}
)

func NewIpv6filteroptionList() list.ListResource {
	return &Ipv6filteroptionList{}
}

type Ipv6filteroptionList struct {
	backend core.BackendType
	service coresvc.Ipv6filteroptionService
}

type Ipv6filteroptionListModel struct {
...
func (l *Ipv6filteroptionList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewIpv6filteroptionService(l.backend, client.NIOS, client.UDDI)
}

func (l *Ipv6filteroptionList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Ipv6filteroption from both the NIOS and UDDI backends.",
...
func (l *Ipv6filteroptionList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data Ipv6filteroptionListModel
...
func (l *Ipv6filteroptionList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data Ipv6filteroptionListModel
	...
	var records []*coremodel.Ipv6filteroption
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Ipv6filteroption, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.Ipv6filteroption, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Ipv6filteroption records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
