...
// RecordHostCloudInfoModel is the Terraform model for RecordHostCloudInfo
...
// RecordHostCloudInfoAttrTypes contains the attribute types for RecordHostCloudInfoModel
...
// RecordHostCloudInfoResourceSchemaAttributes contains the schema attributes for RecordHostCloudInfoModel
...
// ExpandRecordHostCloudInfo converts a Terraform Object to SDK type
func ExpandRecordHostCloudInfo(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.RecordHostCloudInfo {
...
func (m *RecordHostCloudInfoModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.RecordHostCloudInfo {
	if m == nil {
		return nil
	}
	to := &niosdns.RecordHostCloudInfo{
...
// FlattenRecordHostCloudInfo converts an SDK type to Terraform Object
func FlattenRecordHostCloudInfo(ctx context.Context, from *niosdns.RecordHostCloudInfo, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *RecordHostCloudInfoModel) Flatten(ctx context.Context, from *niosdns.RecordHostCloudInfo, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
