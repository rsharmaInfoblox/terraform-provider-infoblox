...
// RecordHostIpv4addrDiscoveredDataModel is the Terraform model for RecordHostIpv4addrDiscoveredData
...
// RecordHostIpv4addrDiscoveredDataAttrTypes contains the attribute types for RecordHostIpv4addrDiscoveredDataModel
...
// RecordHostIpv4addrDiscoveredDataResourceSchemaAttributes contains the schema attributes for RecordHostIpv4addrDiscoveredDataModel
...
// ExpandRecordHostIpv4addrDiscoveredData converts a Terraform Object to SDK type
func ExpandRecordHostIpv4addrDiscoveredData(ctx context.Context, o types.Object, diags *diag.Diagnostics) *niosdns.RecordHostIpv4addrDiscoveredData {
...
func (m *RecordHostIpv4addrDiscoveredDataModel) Expand(ctx context.Context, diags *diag.Diagnostics) *niosdns.RecordHostIpv4addrDiscoveredData {
	if m == nil {
		return nil
	}
	to := &niosdns.RecordHostIpv4addrDiscoveredData{
...
// FlattenRecordHostIpv4addrDiscoveredData converts an SDK type to Terraform Object
func FlattenRecordHostIpv4addrDiscoveredData(ctx context.Context, from *niosdns.RecordHostIpv4addrDiscoveredData, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *RecordHostIpv4addrDiscoveredDataModel) Flatten(ctx context.Context, from *niosdns.RecordHostIpv4addrDiscoveredData, diags *diag.Diagnostics) {
	if from == nil || m == nil {
		return
	}
